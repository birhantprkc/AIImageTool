...
/// <summary>
/// High-precision, perceptual OKLab color transformations with constant-hue gamut compression.
/// Based on the modern OKLab color model, ensuring uniform lightness and superior hue linearity.
/// </summary>
public static class OklabColor
{
    ...
    {
        // Clamp input slightly to avoid negative numbers before non-linear root
        float cr = Math.Max(0f, r);
        float cg = Math.Max(0f, g);
        float cb = Math.Max(0f, b);
