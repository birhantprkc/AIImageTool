...
public static class DevelopModules
{
    ...
    {
        CropOp.Type, OrientationOp.Type, PerspectiveOp.Type, LiquifyOp.Type, LensCorrectionOp.Type, LensProfileOp.Type, HealingOp.Type,
        InputProfileOp.Type,
        FilmNegativeOp.Type,
        ...
        HighlightReconstructionOp.Type, LocalToneMapOp.Type,
        ...
        ColorNoiseReductionOp.Type, LumaNoiseReductionOp.Type, ChromaDenoiseOp.Type, HotPixelOp.Type, CaCorrectOp.Type, DefringeOp.Type,
        ClarityOp.Type, ClaheOp.Type, TextureOp.Type, SharpenOp.Type, DiffuseOp.Type,
        VignetteOp.Type, GrainOp.Type, GlowOp.Type,
    ...
    {
        new("geometry", "Geometry", CropOp.Type, OrientationOp.Type, PerspectiveOp.Type, LiquifyOp.Type, LensCorrectionOp.Type, LensProfileOp.Type),
        ...
        new("tonemap", "Tone Mapping", DehazeOp.Type, FilmicOp.Type, ToneEqualizerOp.Type, SigmoidOp.Type, FilmicRgbOp.Type, RgbLevelsOp.Type, HighlightReconstructionOp.Type, LocalToneMapOp.Type),
        ...
        new("gamut", "Soft Proof / Gamut", GamutMapOp.Type),
        new("detail", "Detail", ColorNoiseReductionOp.Type, LumaNoiseReductionOp.Type, ChromaDenoiseOp.Type, HotPixelOp.Type, CaCorrectOp.Type, DefringeOp.Type, ClarityOp.Type, ClaheOp.Type, TextureOp.Type, SharpenOp.Type, DiffuseOp.Type),
