...
public class PluginAssemblyLoadContext : AssemblyLoadContext
{
    ...
    protected override Assembly? Load(AssemblyName assemblyName)
    {
        ...
        if (assemblyName.Name == null ||
            assemblyName.Name == "ZeroVision.Core" || 
            assemblyName.Name == "ZeroVision.Shared" ||
            assemblyName.Name == "ZeroVision.Imaging" ||
...
public class PluginLoader
{
    ...
    public IEnumerable<IImagePlugin> LoadPlugins(string pluginsPath)
    {
        ...
        var dllFiles = Directory.GetFiles(pluginsPath, "ZeroVision.Plugins.*.dll", SearchOption.AllDirectories);
