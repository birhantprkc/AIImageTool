...
public partial class App : Application
{
    ...
    private void OnStartup(object sender, StartupEventArgs e)
    {
        try
        {
            ...
            batchSvc?.RegisterCapability(new ZeroVision.Shared.ExportBatchAdapter(historySvc));

            var styleSvc = (IStyleService)_serviceProvider.GetService(typeof(IStyleService))!;
            if (styleSvc != null)
                batchSvc?.RegisterCapability(new ZeroVision.Shared.StyleBatchAdapter(styleSvc));
