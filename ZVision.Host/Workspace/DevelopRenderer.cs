...
public sealed class DevelopRenderer
{
        ...
        string path, IReadOnlyList<EditOperation> ops, int pointer)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.RenderPreview", path, ex); return null; }
    }
        ...
        string path, IReadOnlyList<EditOperation> ops, int pointer, int longEdge = 48)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.RenderThumbnail", path, ex); return null; }
    }
    ...
    public AutoTone.Suggestion? AnalyzeAuto(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AnalyzeAuto", path, ex); return null; }
    }
    ...
    public float? AnalyzeStraightenAngle(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AutoStraighten", path, ex); return null; }
    }
    ...
    public AutoUpright.Suggestion? AnalyzeUpright(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AutoUpright", path, ex); return null; }
    }
    ...
    public SmartCrop.Rect? AnalyzeSmartCrop(string path, double ratioW, double ratioH)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.SmartCrop", path, ex); return null; }
    }
    ...
    public (float Red, float Blue)? AnalyzeCaCorrect(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AutoCa", path, ex); return null; }
    }
    ...
    public AutoTone.LevelsSuggestion? AnalyzeAutoLevels(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AnalyzeAutoLevels", path, ex); return null; }
    }
    ...
    public AutoTone.ColorLevelsSuggestion? AnalyzeAutoColor(string path)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AnalyzeAutoColor", path, ex); return null; }
    }
    ...
    public AutoWhiteBalance.Gains? AnalyzeAutoWhiteBalance(string path, AutoWhiteBalance.Strategy strategy = AutoWhiteBalance.Strategy.GrayEdge)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.AutoWB", path, ex); return null; }
    }
    ...
    public AutoWhiteBalance.Gains? SampleWhiteBalance(string path, float nx, float ny)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.SampleWB", path, ex); return null; }
    }
    ...
    public (float R, float G, float B)? SampleFilmBase(string path, float nx, float ny)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.SampleFilmBase", path, ex); return null; }
    }
    ...
    public HistogramData? ComputeHistogram(string path, IReadOnlyList<EditOperation> ops, int pointer)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.Histogram", path, ex); return null; }
    }
    ...
    public WaveformData? ComputeWaveform(string path, IReadOnlyList<EditOperation> ops, int pointer, int columns = 256)
    {
        ...
        catch (Exception ex) { ZVision.Shared.AppLog.Error("DevelopRenderer.Waveform", path, ex); return null; }
    }
}
