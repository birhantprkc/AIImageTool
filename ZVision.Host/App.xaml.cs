...
public partial class App : Application
{
    ...
    public App()
    {
        this.DispatcherUnhandledException += (s, e) =>
        {
            ...
            MessageBox.Show(
                ...
                "ZVision", MessageBoxButton.OK, MessageBoxImage.Error);
            e.Handled = true;
        };
    ...
    private void OnStartup(object sender, StartupEventArgs e)
    {
        try
        {
            ...
            batchSvc?.RegisterCapability(new ZVision.Shared.ExportBatchAdapter(historySvc));

            var styleSvc = (IStyleService)_serviceProvider.GetService(typeof(IStyleService))!;
            if (styleSvc != null)
                batchSvc?.RegisterCapability(new ZVision.Shared.StyleBatchAdapter(styleSvc));
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show(
                ...
                "ZVision - Startup Error", MessageBoxButton.OK, MessageBoxImage.Error);
            Shutdown(1);
        }
    }
}
