...
public class LensfunTests
{
    ...
    {
        var db = LensfunDatabase.ParseXml(Sample);
        var svc = new ZeroVision.Shared.LensfunService(db);
    ...
    {
        var svc = new ZeroVision.Shared.LensfunService(LensfunDatabase.ParseXml(Sample));
    ...
    {
        var svc = new ZeroVision.Shared.LensfunService(new LensfunDatabase());
