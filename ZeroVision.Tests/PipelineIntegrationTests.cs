...
public class PipelineIntegrationTests
{
    ...
    public async System.Threading.Tasks.Task ExportBatchAdapter_BakesEdits_FromHistory()
    {
        ...
        try
        {
            ...
            var history = new ZeroVision.Shared.HistoryService();
            ...
            var adapter = new ZeroVision.Shared.ExportBatchAdapter(history);
            var outDir = Path.Combine(dir, "out");
            var job = new BatchJob
            {
                PluginId = ZeroVision.Shared.ExportBatchAdapter.Plugin,
                OpType = ZeroVision.Shared.ExportBatchAdapter.OpExport,
                InputPath = src,
