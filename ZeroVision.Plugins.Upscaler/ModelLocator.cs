...
namespace ZeroVision.Plugins.Upscaler;

/// <summary>
/// Giải quyết đường dẫn model ONNX một cách BỀN BỈ giữa các layout khác nhau:
/// - Publish (release): Plugins\ZeroVision.Plugins.Upscaler\Models\
...
public static class ModelLocator
{
    ...
    private static string[] CandidateDirs()
    {
        ...
        return new[]
        {
            Path.Combine(baseDir, "Plugins", "ZeroVision.Plugins.Upscaler", "Models"),
