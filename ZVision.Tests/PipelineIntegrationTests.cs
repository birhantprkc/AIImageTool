...
public class PipelineIntegrationTests
{
    ...
    public async System.Threading.Tasks.Task ExportBatchAdapter_BakesEdits_FromHistory()
    {
        ...
        try
        {
            ...
            var history = new ZVision.Shared.HistoryService();
            ...
            var adapter = new ZVision.Shared.ExportBatchAdapter(history);
            var outDir = Path.Combine(dir, "out");
            var job = new BatchJob
            {
                PluginId = ZVision.Shared.ExportBatchAdapter.Plugin,
                OpType = ZVision.Shared.ExportBatchAdapter.OpExport,
                InputPath = src,
