...
public class XmpPresetImporterTests
{
    ...
    public void Parse_ResultReplaysThroughRegistry()
    {
        ...
        var reg = ZVision.Imaging.EditOpRegistry.CreateDefault();
        var ops = XmpPresetImporter.Parse(Sample);
    ...
    public void Parse_ToneCurve_ExtractsNormalizedPoints()
    {
        ...
        var op = ZVision.Imaging.ToneCurveOp.FromParams(curve.Params);
    ...
    public void Parse_SplitToning_ExtractsHueSat()
    {
        ...
        var op = ZVision.Imaging.SplitToningOp.FromParams(sp.Params);
        Assert.False(op.IsIdentity);
    }
    ...
    public void Parse_Hsl_ExtractsBandAdjustments()
    {
        ...
        var op = ZVision.Imaging.HslMixerOp.FromParams(hsl.Params);
        Assert.False(op.IsIdentity);
    }
    ...
    public void Parse_ColorGrading_ExtractsZones()
    {
        ...
        var op = ZVision.Imaging.ColorGradingOp.FromParams(g.Params);
        Assert.False(op.IsIdentity);
    }
