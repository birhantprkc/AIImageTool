...
public class LensfunTests
{
    ...
    {
        var db = LensfunDatabase.ParseXml(Sample);
        var svc = new ZVision.Shared.LensfunService(db);
    ...
    {
        var svc = new ZVision.Shared.LensfunService(LensfunDatabase.ParseXml(Sample));
    ...
    {
        var svc = new ZVision.Shared.LensfunService(new LensfunDatabase());
